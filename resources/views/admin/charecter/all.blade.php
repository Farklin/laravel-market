...
@section('h1', 'Характеристики')
@section('content')



    <div class="col-12">
        <a href="{{ route('admin.charecter.create') }} " class="btn-primary btn">Создать характеристику</a>
    </div>
                ...
                <table class="table mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="border-0">Группа</th>
                    ...
                    <tbody>
                        @foreach ($charecters as $charecter)
                            <tr>
                                ...
                                <td>
                                    <strong>{{ $charecter->group->title }}</strong>
                                </td>
                                <td>
                                    <a href="{{ route('admin.charecter.update', $charecter->id) }}"><i
                                            class="fa fa-edit"></i><span class="d-none d-md-inline-block"> Изменить
                                        </span> </a>
                                </td>
                              
                                <td>
                                    <a class="text-danger" href="{{ route('admin.charecter.delete', $charecter->id) }}"

            ...
            <div class="col-md-3 col-3 position-fixed">
                <ul class="list-group">
                    <li class="list-group-item">
                        <a href="{{ route('admin.category.all') }}"> <i class="fas fa-laptop mr-4 pr-3"></i><span
                                class="d-none d-md-inline-block">Категории</span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.product.all') }}"> <i class="fas fa-bomb mr-5"></i><span
                                class="d-none d-md-inline-block">Товары</span> </a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.page.all') }}"> <i class="fas fa-book mr-5"></i><span
                                class="d-none d-md-inline-block">Страницы</span> </a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.order.all') }}"><i class="fas fa-shopping-cart mr-5"></i><span
                                class="d-none d-md-inline-block">Заказы </span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.subscribers.all') }}"><i class="fas fa-users mr-5"></i><span
                                class="d-none d-md-inline-block">Подписчики</span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.comment.all') }}"><i class="fa fa-comments mr-5"></i><span
                                class="d-none d-md-inline-block">Отзывы</span></a>
                    </li>

                    <li class="list-group-item">
                        <div class="md-v-line" disabled></div><i class="fas fa-cogs mr-5"></i><a><span
                                class="d-none d-md-inline-block"> Настройки</span> </a>
                    </li>
                </ul>
            </div>

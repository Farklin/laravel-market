                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" border="0" class="table660" style="max-width: 660px; min-width: 320px; width: 100%;">
                     <tr>
                         <td align="center" valign="top">
                             ...
                             <a href="https://teisbubble.ru" target="_blank"><img src="https://imgems.ru/ems/templates/logo.png" width="134" border="0" alt="" style="display: inline-block" /></a>
                             <div style="height: 45px; line-height: 45px; font-size: 43px">&nbsp;</div>
                             ...
                             <table cellpadding="0" cellspacing="0" border="0" width="87.9%" align="center">
                                 <tr>
                                     <td>
                                         ...
                                         <div align="center">
                                             <span style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 28px; line-height: 38px; color: #191919;">Вы&nbsp;добавили в&nbsp;корзину товар, но&nbsp;так и&nbsp;не&nbsp;оформили покупку.</span>
                                         ...
                                         <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 100%; min-width: 100%;">
                                             ...
                                             <tr>
                                                 <td style="padding-right: 20px;" width="112" class="mob-pic">
                                                     <a href="" target="_blank"><img src="https://imgems.ru/ems/templates/basket/pic-1.jpg" height="112" width="112" border="0" alt="" style="display: inline-block" /></a>
                                                 </td>
                                                 <td style="padding-right: 10px;">
                                                     <a href="" target="_blank" style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 17px; line-height: 26px; color: #000000; font-weight: bold; text-decoration: none;">Название товара #1</a>
                                                     <div style="height: 5px; line-height: 5px; font-size: 3px">&nbsp;</div>
                                                     <span style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 16px; line-height: 26px; color: #000000;">Краткое описание товара #1</span>
                                                 </td>
                                                 <td style="padding-right: 10px;">
                                                     <span style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 16px; line-height: 26px; color: #000000;">1&nbsp;шт.</span>
                                                 </td>
                                                 <td style="white-space: nowrap;">
                                                     <span style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 16px; line-height: 26px; color: #000000;">2&nbsp;999&nbsp;&#8381;</span>
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td height="10">&nbsp;</td>
                                         ...
                                         <div style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 15px; line-height: 22px; color: #999999;">Хороших покупок,<br />ваш Valar Morghulis</div>
                                         ...
                                         <div style="height: 35px; line-height: 35px; font-size: 33px">&nbsp;</div>
                                         <div align="center">
                                             <div style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 13px; line-height: 18px; color: #999999;">Вы&nbsp;получили данное письмо, так как подписались на&nbsp;рассылку <a href="" target="_blank" style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 13px; line-height: 18px; color: #999999; text-decoration: none;">emailsoldiers.ru</a>.</div>
                                             <div style="height: 5px; line-height: 5px; font-size: 3px">&nbsp;</div>
                                             <a href="" target="_blank" style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 12px; line-height: 18px; color: #191919; text-decoration: none;">Отписаться от рассылки</a>
                                             <div style="height: 30px; line-height: 30px; font-size: 28px">&nbsp;</div>
                                             <div style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 13px; line-height: 18px; color: #999999;">Разработано в <a href="https://emailsoldiers.ru/?utm_source=emailsoldiers&utm_medium=whitepaper&utm_campaign=28-email-templates-for-ecommerce" target="_blank" style="font-family: system-ui, -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 13px; line-height: 18px; color: #191919; text-decoration: none;">Email Soldiers</a></div>
                                         </div>
                                         <div style="height: 45px; line-height: 45px; font-size: 43px">&nbsp;</div>
                                     </td>
                                 </tr>
